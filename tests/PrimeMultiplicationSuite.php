<?php
namespace APSingh\PrimeGenerator\Tests;

use APSingh\PrimeGenerator\Prime;
use APSingh\PrimeGenerator\PrimeMultiplication as PM;
use APSingh\PrimeGenerator\Util\Math;
