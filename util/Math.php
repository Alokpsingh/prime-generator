<?php
namespace APSingh\PrimeGenerator\Util;

class Math
{
    final public static function random($min, $max)
    {
        return rand($min, $max);
    }

    final public static function mod_pow($base, $exp, $mod)
    {
    ...
    final private static function pow2($exp, $acc = 1)
    {
        if ($exp > 63 || $exp < 0) {
